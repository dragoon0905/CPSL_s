    ...
    for epoch in range(start_epoch, opt.epochs):
        for data_i in datasets.target_train_loader:
            ...
            if opt.stage == 'warm_up':
                ...
                loss, loss_CTS, loss_consist, loss_SL, loss_contrast, queue, queue_out = model.step(images, labels, target_image, queue, queue_label, queue_out, use_the_queue, use_the_queue_out, target_imageS, target_params, target_lp, target_lpsoft, target_image_full, target_weak_params)
            else:
